...
\begin{cventries}
	...
	{Improving Vehicular Visible Light Communication with Neuromorphic Cameras}
	{ACM HotMobile}
	{2023}
	{
		\begin{cvitems} % Description(s) bullet points
			\item {When neuromorphic cameras meet VLC: a spike cameras as VLC receiver achieves 4.8 kbps data rate and different mobile scenarios.}
		\end{cvitems}
	}
