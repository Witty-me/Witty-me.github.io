...
\begin{cventries}
	...
	{2025.08 - Present} % Date(s)
	{
		\begin{cvitems} % Description(s) bullet points
			...
			\item {Led the research and deployment of Wi-Fi CSI (Channel State Information) wireless sensing technologies for smart security and smart buildings, spearheading the design and development of end-to-end AI algorithm architectures.}
